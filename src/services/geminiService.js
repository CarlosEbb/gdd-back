...
class GeminiService {
    ...
    reemplazarBase64(jsonString) {
        ...
        if (base64Restantes > 0) {
            console.warn(`⚠️ Aún quedan ${base64Restantes} posibles base64 sin reemplazar`);
    ...
    async generatePDFMESchema(prompt) {
        const jsonEjemplo = '{"schemas":[[{"name":"campo1","type":"multiVariableText","content":"{}","position":{"x":0.01,"y":75.15},"width":215.89,"height":15,"rotate":0,"alignment":"center","verticalAlignment":"top","fontSize":18,"lineHeight":1,"characterSpacing":0,"fontColor":"#000000","backgroundColor":"","opacity":1,"strikethrough":false,"underline":false,"readOnly":true,"text":"CONSTANCIA DE TEST","variables":[],"required":false},{"name":"campo1 copy","type":"multiVariableText","content":"{\"nombre_empleado\":\"______________________________\\n\",\"apellido_empleado\":\"______________________________ \",\"cedula\":\"V-XX.XXX.XXX\",\"cargo\":\"MANTENIMIENTO\",\"lugar_fecha\":\"Caracas, el 03 de diciembre de 2025.\",\"monto\":\"bolívares equis mil equis equis y equis con XX/XX (Bs. XX.XXX,XX).\"}","position":{"x":31.63,"y":94.04},"width":155.56,"height":98.34,"rotate":0,"alignment":"left","verticalAlignment":"top","fontSize":12,"lineHeight":1.5,"characterSpacing":0,"fontColor":"#000000","backgroundColor":"","opacity":1,"strikethrough":false,"underline":false,"readOnly":false,"text":"Por medio de la presente se hace constar que {nombre_empleado} {apellido_empleado}, titular de la Cédula de Identidad {cedula}, labora actualmente en esta empresa desde el 06 de julio de 2021, desempeñando el cargo de {cargo} y devengando actualmente:\\n\\nPor concepto de salario mensual {monto}\\n\\nConstancia que se expide a petición de la parte interesada en {lugar_fecha}\\n\\nAtentamente,","variables":["nombre_empleado","apellido_empleado","cedula","cargo","lugar_fecha","monto"],"required":false},{"name":"campo7","type":"multiVariableText","content":"{\"empledo_rrh\":\"Camilo Rodríguez\",\"cargo_rrh\":\"Director de Recursos Humanos\"}","position":{"x":0,"y":222.58},"width":215.89,"height":15,"rotate":0,"alignment":"center","verticalAlignment":"top","fontSize":13,"lineHeight":1,"characterSpacing":0,"fontColor":"#000000","backgroundColor":"","opacity":1,"strikethrough":false,"underline":false,"readOnly":false,"text":"{empledo_rrh}\\n{{cargo_rrh}}","variables":["empledo_rrh","cargo_rrh"],"required":false}]],"basePdf":{"width":215.9,"height":279.4,"padding":[0,0,0,0]},"pdfmeVersion":"5.4.6"}';
        
        // Prompt más específico para evitar problemas
        const promptFinal = `IMPORTANTE: Genera ÚNICAMENTE un JSON válido para pdfme. No incluyas texto adicional, explicaciones o marcadores de código.
            ...
            Tipos de elementos disponibles: text, multiVariableText, image, line, rectangle

            INSTRUCCIONES CRÍTICAS:
            1. NO incluyas imágenes base64 reales - usa "file": "" para imágenes
            2. Asegúrate que todas las comillas estén escapadas correctamente
            3. No cortes el JSON - debe estar completo
            4. Las coordenadas (x, y) deben estar en milímetros
            5. Si usas variables, el formato debe ser: "content": "{\\"variable\\":\\"valor\\"}"

            Ejemplo de elemento con variables:
            {
            "name": "campo_texto",
            "type": "multiVariableText",
            "content": "{\\"nombre\\":\\"Ejemplo\\",\\"fecha\\":\\"2024\\"}",
            "position": {"x": 10, "y": 20},
            "width": 100,
            "height": 50,
            "text": "Hola {nombre}, fecha: {fecha}",
        ...
        const respuestaTexto = await this.generateContent(promptFinal);
        return await this.parsearRespuestaJSON(respuestaTexto);
    }
            ...
            for (const [key, value] of Object.entries(obj)) {
                ...
                if (typeof value === 'string') {
                    if (value.includes('base64')) {
                        console.warn(`⚠️ Se encontró base64 en ${currentPath}: ${value.substring(0, 100)}...`);
                    }
    ...
    extraerJSONValido(jsonString) {
        ...
        try {
            ...
            if (inicio !== -1 && fin > inicio) {
                ...
                console.log('Extraído (primeros 300 chars):', posibleJSON.substring(0, 300));
